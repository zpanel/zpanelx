...
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values (117,'theme_default','Theme','zpanelx',NULL,'Set the default theme for zpanelx','Zpanel Config','true');

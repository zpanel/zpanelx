...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo TXT_INDEX_TITLE; ?></title>
...
<div class="content">
	<h1><?php echo TXT_INDEX_HOSTING_SPACE; ?> </h1>
	<p><?php echo TXT_INDEX_HOSTING_SPACE2; ?></p>
	<p><b><?php echo TXT_INDEX_GET_STARTED; ?>:</b>
	<ol>
		<li><p><?php echo TXT_INDEX_LOGIN_ACCOUNT; ?></p></li>
		<li><p><?php echo TXT_INDEX_FTP_ACCOUNT; ?></p></li>
		<li><p><?php echo TXT_INDEX_REPLACE_INDEX; ?></p></li>
	</ol>
	</p>
	<p><?php echo TXT_INDEX_THANK_HOSTING; ?></p>
	<p><b><?php echo TXT_INDEX_INFORMATION_VISIT; ?>:</b> <a href="http://www.zpanelcp.com/" target="_blank">www.zpanelcp.com</a>.</p>
	<p><?php echo TXT_INDEX_KIND_REGARDS; ?>,<br />
	<?php echo TXT_INDEX_HOSTING_COMPANY; ?>.</p>
</div>

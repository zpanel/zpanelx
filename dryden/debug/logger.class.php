...
class debug_logger {
    ...
    function writeLog() {
        ...
        if ($this->method == "screen") {
            ...
            try {
                $statement = "INSERT INTO x_logs (lg_user_fk, lg_code_vc, lg_module_vc, lg_detail_tx, lg_stack_tx, lg_when_ts) VALUES (0, '" . $this->logcode . "', 'NA', '" . $this->detail . "', '" . $this->mextra . "', now())";

...
<html dir="ltr"><head>
    ...
    <!-- EXTERNAL CSS -->
    <link href="cPanel%20Login_fichiers/style_v2_optimized2.css" rel="stylesheet" type="text/css">
            ...
            <div id="login-sub-container">
                ...
                <div id="login-sub">
                    <div id="forms">
                                                    ...
                                                    <form id="reset_form" action="/resetpass" method="post" style="visibility:hidden">
                                <div class="input-req-login"><label for="reset_pass_username">Username</label></div>
                                <div class="input-field-login icon reset-pass-container">
                                    <input name="user" id="reset_pass_username" class="std_textbox" autocomplete="off" tabindex="1" placeholder="Enter your username." required="" type="text">
                                </div>
                                <div style="width: 285px;">
                                    <div class="login-btn"><button name="login" type="submit" id="reset_submit" tabindex="2">Reset password</button></div>
                                    <div class="reset-pw"><a href="javascript:void(0)" onclick="return hide_reset();">Cancel</a></div>
                                </div>
                                <div class="clear" id="push"></div>
                            </form>
                        
							<form action="index.php?resetkey=<?php echo $_GET['resetkey']; ?>" method="post" name="frmZConfirm" id="frmZConfirm">
                            <?php echo TXT_DEFAULT_NEW_PASSWORD; ?>
							<div class="input-field-login icon username-container">
							<input name="inNewPass" id="inNewPass" autofocus="autofocus" value="" placeholder="" class="std_textbox" type="password"  tabindex="1" required>
                            <?php echo TXT_DEFAULT_YOUR_EMAIL; ?>
                            <div class="input-field-login icon password-container">
							<input name="inConfEmail" id="inConfEmail" placeholder="" class="std_textbox" type="text" tabindex="2"  required>
							<?php echo TXT_DEFAULT_RETYPE_PASSWORD; ?>
                            <div class="input-field-login icon password-container">
							<input name="inNewPass2" id="inNewPass2" placeholder="" class="std_textbox" type="password" tabindex="2"  required>
                            </div>
                            <div style="width: 285px;">
                                <div class="login-btn">
                                    <button name="login" type="submit" id="login_submit" tabindex="3"><?php echo TXT_LIMELOGINTEMPLATE_RESET; ?></button>
                                </div>

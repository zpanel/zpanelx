...
$p2 = "30019295";
$p3 = "postmaster@ks392623.kimsufi.com";
$p4 = "25";
$p5 = "143";
$p6 = "ks392623.kimsufi.com";
...
$sql = "SET PASSWORD FOR `webmail`@`localhost`=PASSWORD('" . $p1 . "')";
if (mysql_query($sql, $link)) {
} else {
    echo 'Error creating the database : ' . mysql_error() . "\n";
}

$file1 = @fopen("/etc/zpanel/panel/modules/webmail/apps/AfterLogic/data/settings/settings.xml", "w");
...
");
fclose($file1);
$file2 = @fopen("/etc/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
fwrite($file2, "<?php
\$rcmail_config = array();
\$rcmail_config['db_dsnw'] = 'mysql://webmail:" . $p1 . "@localhost/zpanel_roundcube';
...
");
fclose($file2);
$file3 = @fopen("/etc/zpanel/panel/modules/webmail/apps/atmail/libs/Atmail/Config.php", "w");
fwrite($file3, "<?php
...
$file4 = @fopen("/etc/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");
fwrite($file4, "<?php
global \$version;
...
");
fclose($file4);
$file5 = @fopen("/etc/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf", "w");
fwrite($file5, "host_name = " . $p6 . "
...
exec("mysql -h localhost -u root -p" . $pass . " zpanel_atmail < /etc/zpanel/panel/modules/webmail/install/zpanel_atmail.sql");
exec("mysql -h localhost -u root -p" . $pass . " zpanel_AfterLogic < /etc/zpanel/panel/modules/webmail/install/zpanel_AfterLogic_linux.sql");
?>
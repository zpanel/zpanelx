function DelContact(type,email, id) {
	...
	if(type == "group") {
		if (confirm(['Are you sure you want to delete the group \'' + email + '\' from your Addressbook?'])) {
		...
		if (confirm(['Are you sure you want to delete the user \'' + email + '\' from your Addressbook?'])) {

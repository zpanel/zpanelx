...
else if(document.mail.NewFolder.options[document.mail.NewFolder.selectedIndex].value == 'erase' && !confirm("Are you sure you want to permanently delete the selected messages?") )	{
return false;
}

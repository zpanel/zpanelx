...
else if(document.mail.NewFolder.options[document.mail.NewFolder.selectedIndex].value == 'erase' && !confirm("Weet u zeker dat u de geselecteerde berichten definitief wilt verwijderen?") )	{
return false;
}

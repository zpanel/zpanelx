function DelContact(type,email, id) {
	...
	if(type == "group") {
		if (confirm(['Weet u zeker dat u de groep \'' + email + '\' uit uw adresboek wilt verwijderen?'])) {
		...
		if (confirm(['Weet u zeker dat u de gebruiker \'' + email + '\' uit uw adresboek wilt verwijderen?'])) {

function DelContact(type,email, id) {
	...
	if(type == "group") {
		if (confirm(['Möchten Sie die Gruppe \'' + email + '\' wirklich aus Ihrem Adressbuch löschen?'])) {
		...
		if (confirm(['Möchten Sie den Benutzer \'' + email + '\' wirklich aus Ihrem Adressbuch löschen?'])) {

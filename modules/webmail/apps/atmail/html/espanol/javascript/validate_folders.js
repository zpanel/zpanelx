...
function validate_form(theForm)
{
  ...
  {
    alert("El nombre de la carpeta no puede contener mas de 64 caracteres, introduce un nuevo nombre.");
    theForm.foldername.focus();
    return (false);
  }
  ...
  if (utf7enabled == 1) {
	  ...
	  if (!allValid)
	  {
	    ...
	    alert("Please specify under 64 characters for the Foldername");
	    return (false);
	  } else	 {
		return true;
	  }

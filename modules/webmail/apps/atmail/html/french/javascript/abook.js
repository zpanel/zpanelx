function DelContact(type,email, id) {
	...
	if(type == "group") {
		if (confirm(['Etes-vous certain de vouloir effacer le groupe \'' + email + '\' de votre carnet d\'adresses ?'])) {
		...
		if (confirm(['Etes-vous certain de vouloir effacer l\'utilisateur \'' + email + '\' de votre carnet d\'adresses ?'])) {

...
define('MobileSyncHintDesc', 'Utilice estos ajustes para sincronizar su calendario con su dispositivo móvil con soporte para el protocolo CalDAV. Con iPhone, por ejemplo, usted usualmente necesitará la URL del servidor, el usuario de sincronización y su contraseñ.');

define('MobileGetIOSSettings', 'Entrega de correo electrónico y la configuración del calendario en tu dispositivo iOS');

...
<d:expand-property xmlns:d="DAV:">
    <d:property name="calendar-proxy-read-for" namespace="'.Sabre_CalDAV_Plugin::NS_CALENDARSERVER.'">
        <d:property name="calendar-home-set" namespace="'.Sabre_CalDAV_Plugin::NS_CALDAV.'" />
    </d:property>
    <d:property name="calendar-proxy-write-for" namespace="'.Sabre_CalDAV_Plugin::NS_CALENDARSERVER.'">
        <d:property name="calendar-home-set" namespace="'.Sabre_CalDAV_Plugin::NS_CALDAV.'" />
    </d:property>
</d:expand-property>';

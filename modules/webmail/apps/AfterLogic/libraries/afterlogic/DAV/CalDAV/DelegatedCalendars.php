...
class afterlogic_DAV_CalDAV_DelegatedCalendars implements Sabre_DAV_IExtendedCollection, Sabre_DAVACL_IACL {
    ...
    public function getChildren() {
        ...
        $calendars = $this->caldavBackend->getDeligatedCalendarsForUser($this->principalInfo['id']);
        $objs = array();
        foreach($calendars as $calendar) {
            $objs[] = new afterlogic_DAV_Delegates_Calendar($this->principalBackend, $this->caldavBackend, $calendar);
        }
        return $objs;

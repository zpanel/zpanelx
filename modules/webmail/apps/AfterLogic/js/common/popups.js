	...
	hidePopup: function ()
	{
		...
		if (this.sTitleOverClass != '') {
			this.eControl.onmouseover = function () {
				obj.eTitle.className = obj.sTitleOverClass + (obj.disable ? ' wm_toolbar_item_disabled' : '');
				obj.eControl.className = obj.sControlOverClass;
			};
			this.eControl.onmouseout = function () {
				obj.eTitle.className = obj.sTitleClass + (obj.disable ? ' wm_toolbar_item_disabled' : '');

...
<div id="message_page<?php if ($pd->pd['new_window']) { echo '_win'; } ?>"><?php echo do_display_hook('message_top') ?>

    <!-- message headers -->

    <div id="message_headers">
        <table cellpadding="0" cellspacing="0" width="100%">
    <tr><td colspan="2"></td><td rowspan="2" valign="top" class="prev_next_cell">
    ...
    <div id="prev_next">
        ...
        <?php echo $pd->print_message_headers(2) ?>
...
<!-- links to pages of the mailbox  -->
    <?php if ($pd->pd['new_window']) { echo '</div>'; } ?> 

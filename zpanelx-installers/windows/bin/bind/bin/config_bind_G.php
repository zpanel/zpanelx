...
$rndcconfgen="G:/zpanel/bin/bind/bin/rndc-confgen.exe";
$rcnd="G:/zpanel/bin/bind/etc/rndc.conf";
$logdir='G:/zpanel/logs/bind/';
$nameddir="G:\\zpanel\\bin\\bind\\etc\\";
$zonedir="G:/zpanel/bin/bind/zones/";
$zonedir="G:/zpanel/bin/bind/zones/";
$configdir="G:/zpanel/configs/bind/";
$configetcdir="G:/zpanel/configs/bind/etc/";
$configzonedir="G:/zpanel/configs/bind/zones/";
##########################################################################################################
...
include "G:\\zpanel\\configs\\bind\\etc\\named.conf";
include "G:\\zpanel\\configs\\bind\\etc\\named.conf.slave";';
...
system('CACLS G:/zpanel/bin/bind/*.* /T /E /C /G "Users":C');
?>
...
$rndcconfgen="F:/zpanel/bin/bind/bin/rndc-confgen.exe";
$rcnd="F:/zpanel/bin/bind/etc/rndc.conf";
$logdir='F:/zpanel/logs/bind/';
$nameddir="F:\\zpanel\\bin\\bind\\etc\\";
$zonedir="F:/zpanel/bin/bind/zones/";
$zonedir="F:/zpanel/bin/bind/zones/";
$configdir="F:/zpanel/configs/bind/";
$configetcdir="F:/zpanel/configs/bind/etc/";
$configzonedir="F:/zpanel/configs/bind/zones/";
##########################################################################################################
...
include "F:\\zpanel\\configs\\bind\\etc\\named.conf";
include "F:\\zpanel\\configs\\bind\\etc\\named.conf.slave";';
...
a.root-servers.net.	3600000	IN	AAAA	2001:503:ba3c::2:30
...
system('CACLS F:/zpanel/bin/bind/*.* /T /E /C /G "Users":C');
?>
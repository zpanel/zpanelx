...
$roundcube_config = fopen("C:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < C:\zpanel\bin\hmailserver\INSTALL\zpanel_hmail.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_afterlogic < C:\zpanel\panel\modules\webmail\install\zpanel_afterlogic.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_atmail < C:\zpanel\panel\modules\webmail\install\zpanel_atmail.sql");
...
$afterLogicsettings = @fopen("C:/zpanel/panel/modules/webmail/apps/AfterLogic/data/settings/settings.xml", "w");
...
$atmailconfig = @fopen("C:/zpanel/panel/modules/webmail/apps/atmail/libs/Atmail/config.php", "w");
...
");
fclose($atmailconfig);
$squirrelmailconfig = @fopen("C:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");
...
$hastymail_config_file = @fopen("C:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf", "w");
fwrite($hastymail_config_file, "host_name = " . $location . "
url_base = /modules/webmail/apps/Hastymail/
http_prefix = http
attachments_path = C:/zpanel/panel/modules/webmail/apps/Hastymail/attachments
settings_path = C:/zpanel/panel/modules/webmail/apps/Hastymail/user_settings
imap_port = 143
...
fclose($hastymail_config_file);
    ...
    if (!empty($conf)) {
        $data = serialize($conf);
			$hastymail_config_file2 = fopen("C:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.rc", "w");
fwrite($hastymail_config_file2, "".$data."");
fclose($hastymail_config_file2);
    }
$newmailconfig = @fopen("C:/zpanel/panel/modules/webmail/install/newmail.sql", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < C:/zpanel/panel/modules/webmail/install/newmail.sql");
fwrite(STDOUT, "\r
################################################################\r

...
$db_settings_file = fopen("C:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
$sqlFileToExecute = "C:/zpanel/panel/modules/webmail/apps/roundcube/SQL/mysql.initial.sql";
...
$sqlFileToExecute = "C:/zpanel/panel/modules/webmail/install/zpanel_afterlogic.sql";
$res = RunSQL($sqlFileToExecute);

mysql_select_db('zpanel_atmail', $db);
$sqlFileToExecute = "C:/zpanel/panel/modules/webmail/install/zpanel_atmail.sql";
$res = RunSQL($sqlFileToExecute);
...
$newmailconfig = @fopen("C:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");	

...
$db_settings_file = fopen("D:/zpanel/panel/cnf/db.php", "w");
...
$roundcube_config = fopen("D:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < D:\zpanel\bin\hmailserver\INSTALL\zpanel_hmail.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_afterlogic < D:\zpanel\panel\modules\webmail\install\zpanel_afterlogic.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_atmail < D:\zpanel\panel\modules\webmail\install\zpanel_atmail.sql");
...
$db_settings_file = @fopen("D:/zpanel/bin/hmailserver/Bin/hMailServer.ini", "w");
...
fwrite($db_settings_file, "ProgramFolder=D:\zpanel\bin\hmailserver\r\n");
fwrite($db_settings_file, "DataFolder=D:\zpanel\bin\hmailserver\Data\r\n");
fwrite($db_settings_file, "LogFolder=D:\zpanel\logs\r\n");
fwrite($db_settings_file, "TempFolder=D:\zpanel\bin\hmailserver\Temp\r\n");
fwrite($db_settings_file, "EventFolder=D:\zpanel\bin\hmailserver\Events\r\n");
fwrite($db_settings_file, "\r\n");
...
$afterLogicsettings = @fopen("D:/zpanel/panel/modules/webmail/apps/AfterLogic/data/settings/settings.xml", "w");
...
$atmailconfig = @fopen("D:/zpanel/panel/modules/webmail/apps/atmail/libs/Atmail/config.php", "w");
...
For additional information about the email service contact the Administrator \$pref[admin_email]',
  ...
  'pallow_City' => '1',
  'mailserver' => '',
  'user_dir' => 'D:/zpanel/panel/modules/webmail/apps/atmail',
  'GlobalAbook' => '0',
  'allow_DateFormat' => '1',
  'pallow_State' => '1',
  'smtp_popimaprelay' => '1',
  ...
  'sql_type' => 'mysql',
  'smtp_auth' => '1',
  'install_dir' => 'D:/zpanel/panel/modules/webmail/apps/atmail',
...
");
fclose($atmailconfig);
$squirrelmailconfig = @fopen("D:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");
...
\$data_dir = 'D:/zpanel/panel/modules/webmail/apps/squirrelmail/data/';
\$attachment_dir = 'D:/zpanel/panel/modules/webmail/apps/squirrelmail/attach/';
\$dir_hash_level = 0;
...
$hastymail_config_file = @fopen("D:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf", "w");
fwrite($hastymail_config_file, "host_name = " . $location . "
url_base = /modules/webmail/apps/Hastymail/
http_prefix = http
attachments_path = D:/zpanel/panel/modules/webmail/apps/Hastymail/attachments
settings_path = D:/zpanel/panel/modules/webmail/apps/Hastymail/user_settings
imap_port = 143
...
fclose($hastymail_config_file);
    ...
    $atts = "D:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf";
    ...
    if (!empty($conf)) {
        $data = serialize($conf);
			$hastymail_config_file2 = fopen("D:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.rc", "w");
fwrite($hastymail_config_file2, "".$data."");
fclose($hastymail_config_file2);
    }
$newmailconfig = @fopen("D:/zpanel/panel/modules/webmail/install/newmail.sql", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < D:/zpanel/panel/modules/webmail/install/newmail.sql");
fwrite(STDOUT, "\r
################################################################\r
...
Password: " . $p2 . "\r
\r
These details can also be found in D:\zpanel\login_details.txt\r
\r
...
exec("D:/zpanel/bin/zpss/setroute.exe " . $location . "");

// Add the password details to a file in D:\zpanel
$db_settings_file = fopen("D:/zpanel/login_details.txt", "w");

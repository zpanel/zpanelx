...
$db_settings_file = fopen("D:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
$sqlFileToExecute = "D:/zpanel/panel/modules/webmail/apps/roundcube/SQL/mysql.initial.sql";
$res = RunSQL($sqlFileToExecute);

// Insert hMailServer inital SQL into the zpanel_hmail database.
mysql_select_db('zpanel_hmail', $db);
$sqlFileToExecute = "D:/zpanel/bin/hmailserver/INSTALL/zpanel_hmail.sql";
$res = RunSQL($sqlFileToExecute);

mysql_select_db('zpanel_afterlogic', $db);
$sqlFileToExecute = "D:/zpanel/panel/modules/webmail/install/zpanel_afterlogic.sql";
$res = RunSQL($sqlFileToExecute);

mysql_select_db('zpanel_atmail', $db);
$sqlFileToExecute = "D:/zpanel/panel/modules/webmail/install/zpanel_atmail.sql";
$res = RunSQL($sqlFileToExecute);
...
$newmailconfig = @fopen("D:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");	

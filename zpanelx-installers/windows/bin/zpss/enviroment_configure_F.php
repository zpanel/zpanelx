...
$db_settings_file = @fopen("F:/zpanel/bin/hmailserver/Bin/hMailServer.ini", "w");
...
fwrite($db_settings_file, "ProgramFolder=F:\zpanel\bin\hmailserver\r\n");
fwrite($db_settings_file, "DataFolder=F:\zpanel\bin\hmailserver\Data\r\n");
fwrite($db_settings_file, "LogFolder=F:\zpanel\logs\r\n");
fwrite($db_settings_file, "TempFolder=F:\zpanel\bin\hmailserver\Temp\r\n");
fwrite($db_settings_file, "EventFolder=F:\zpanel\bin\hmailserver\Events\r\n");
fwrite($db_settings_file, "\r\n");
...
$atmailconfig = @fopen("F:/zpanel/panel/modules/webmail/apps/atmail/libs/Atmail/config.php", "w");
...
For additional information about the email service contact the Administrator \$pref[admin_email]',
  ...
  'pallow_City' => '1',
  'mailserver' => '',
  'user_dir' => 'F:/zpanel/panel/modules/webmail/apps/atmail',
  'GlobalAbook' => '0',
  'allow_DateFormat' => '1',
  'pallow_State' => '1',
  'smtp_popimaprelay' => '1',
  ...
  'sql_type' => 'mysql',
  'smtp_auth' => '1',
  'install_dir' => 'F:/zpanel/panel/modules/webmail/apps/atmail',
...
");
fclose($atmailconfig);
$squirrelmailconfig = @fopen("F:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");
...
\$data_dir = 'F:/zpanel/panel/modules/webmail/apps/squirrelmail/data/';
\$attachment_dir = 'F:/zpanel/panel/modules/webmail/apps/squirrelmail/attach/';
\$dir_hash_level = 0;
...
$hastymail_config_file = @fopen("F:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf", "w");
fwrite($hastymail_config_file, "host_name = " . $location . "
url_base = /modules/webmail/apps/Hastymail/
http_prefix = http
attachments_path = F:/zpanel/panel/modules/webmail/apps/Hastymail/attachments
settings_path = F:/zpanel/panel/modules/webmail/apps/Hastymail/user_settings
imap_port = 143
...
fclose($hastymail_config_file);
    ...
    $atts = "F:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf";
    ...
    if (!empty($conf)) {
        $data = serialize($conf);
			$hastymail_config_file2 = fopen("F:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.rc", "w");

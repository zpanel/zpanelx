...
$db_settings_file = fopen("G:/zpanel/panel/cnf/db.php", "w");
...
$roundcube_config = fopen("G:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < G:\zpanel\bin\hmailserver\INSTALL\zpanel_hmail.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_afterlogic < G:\zpanel\panel\modules\webmail\install\zpanel_afterlogic.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_atmail < G:\zpanel\panel\modules\webmail\install\zpanel_atmail.sql");
...
$newmailconfig = @fopen("G:/zpanel/panel/modules/webmail/install/newmail.sql", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < G:/zpanel/panel/modules/webmail/install/newmail.sql");
fwrite(STDOUT, "\r
################################################################\r

...
$db_settings_file = fopen("E:/zpanel/panel/cnf/db.php", "w");
...
$roundcube_config = fopen("E:/zpanel/panel/modules/webmail/apps/roundcube/config/db.inc.php", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < E:\zpanel\bin\hmailserver\INSTALL\zpanel_hmail.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_afterlogic < E:\zpanel\panel\modules\webmail\install\zpanel_afterlogic.sql");
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_atmail < E:\zpanel\panel\modules\webmail\install\zpanel_atmail.sql");
...
$db_settings_file = @fopen("E:/zpanel/bin/hmailserver/Bin/hMailServer.ini", "w");
...
fwrite($db_settings_file, "ProgramFolder=E:\zpanel\bin\hmailserver\r\n");
fwrite($db_settings_file, "DataFolder=E:\zpanel\bin\hmailserver\Data\r\n");
fwrite($db_settings_file, "LogFolder=E:\zpanel\logs\r\n");
fwrite($db_settings_file, "TempFolder=E:\zpanel\bin\hmailserver\Temp\r\n");
fwrite($db_settings_file, "EventFolder=E:\zpanel\bin\hmailserver\Events\r\n");
fwrite($db_settings_file, "\r\n");
...
$afterLogicsettings = @fopen("E:/zpanel/panel/modules/webmail/apps/AfterLogic/data/settings/settings.xml", "w");
...
$atmailconfig = @fopen("E:/zpanel/panel/modules/webmail/apps/atmail/libs/Atmail/config.php", "w");
...
For additional information about the email service contact the Administrator \$pref[admin_email]',
  ...
  'pallow_City' => '1',
  'mailserver' => '',
  'user_dir' => 'E:/zpanel/panel/modules/webmail/apps/atmail',
  'GlobalAbook' => '0',
  'allow_DateFormat' => '1',
  'pallow_State' => '1',
  'smtp_popimaprelay' => '1',
  ...
  'sql_type' => 'mysql',
  'smtp_auth' => '1',
  'install_dir' => 'E:/zpanel/panel/modules/webmail/apps/atmail',
...
");
fclose($atmailconfig);
$squirrelmailconfig = @fopen("E:/zpanel/panel/modules/webmail/apps/squirrelmail/config/config.php", "w");
...
\$data_dir = 'E:/zpanel/panel/modules/webmail/apps/squirrelmail/data/';
\$attachment_dir = 'E:/zpanel/panel/modules/webmail/apps/squirrelmail/attach/';
\$dir_hash_level = 0;
...
$hastymail_config_file = @fopen("E:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf", "w");
fwrite($hastymail_config_file, "host_name = " . $location . "
url_base = /modules/webmail/apps/Hastymail/
http_prefix = http
attachments_path = E:/zpanel/panel/modules/webmail/apps/Hastymail/attachments
settings_path = E:/zpanel/panel/modules/webmail/apps/Hastymail/user_settings
imap_port = 143
...
fclose($hastymail_config_file);
    ...
    $atts = "E:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.conf";
    ...
    if (!empty($conf)) {
        $data = serialize($conf);
			$hastymail_config_file2 = fopen("E:/zpanel/panel/modules/webmail/apps/Hastymail/hastymail2.rc", "w");
fwrite($hastymail_config_file2, "".$data."");
fclose($hastymail_config_file2);
    }
$newmailconfig = @fopen("E:/zpanel/panel/modules/webmail/install/newmail.sql", "w");
...
exec("mysql -h localhost -u root -p" . $p1 . " zpanel_hmail < E:/zpanel/panel/modules/webmail/install/newmail.sql");
fwrite(STDOUT, "\r
################################################################\r
...
Password: " . $p2 . "\r
\r
These details can also be found in E:\zpanel\login_details.txt\r
\r
...
exec("E:/zpanel/bin/zpss/setroute.exe " . $location . "");

// Add the password details to a file in E:\zpanel
$db_settings_file = fopen("E:/zpanel/login_details.txt", "w");
